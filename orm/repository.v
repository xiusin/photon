...
pub mut:
	...
	exec_find     fn (conn voidptr, id int) !T     = unsafe { nil }
	exec_find_all fn (conn voidptr) ![]T           = unsafe { nil }
	exec_insert   fn (conn voidptr, entity T) !    = unsafe { nil }
	exec_update   fn (conn voidptr, entity T) !    = unsafe { nil }
